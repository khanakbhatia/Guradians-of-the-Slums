...
- Granite response quality: grounded response rate, citation coverage, answer completeness
- Latency: average, p50, p95, latency score
- Confidence: Brier score, calibration score, empirical accuracy

## Design

The pipeline is data-driven. It accepts predictions plus reference labels or expected outputs and returns structured JSON metrics. It does not execute models, call Granite, render UI, or mutate production data.
